  ...
  return (
    <nav className="relative flex w-full flex-wrap items-center justify-between bg-zinc-50 py-2 shadow-dark-mild dark:bg-neutral-700 lg:py-4">
      <div className="flex w-full flex-wrap items-center justify-between px-3">
        ...
        <ul
          className="list-style-none mx-auto hidden flex-row ps-0 md:flex"
        ...
        >
          <li className="px-2" data-twe-nav-item-ref>
            ...
            >
              ...
              <span className="absolute -mt-7 ms-4 rounded-full bg-danger px-[0.50em] py-[0.25em] text-[0.6rem] font-bold leading-none text-white">
                1
              </span>
            </a>
          </li>
          ...
          <li className="px-2" data-twe-nav-item-ref>
            ...
            >
              ...
              <span className="absolute -mt-7 ms-5 rounded-full bg-danger px-[0.50em] py-[0.25em] text-[0.6rem] font-bold leading-none text-white">
                2
              </span>
            </a>
          </li>
        ...
        >
          <li className="px-2" data-twe-nav-item-ref>
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <strong className="ms-1 hidden sm:block">John</strong>
            </a>
          </li>
          ...
          >
            ...
            >
              ...
              <span className="absolute -mt-6 ms-3 rounded-full bg-danger px-[0.50em] py-[0.25em] text-[0.6rem] font-bold leading-none text-white">
                12
              </span>
            </a>
